...
<section class="z-20 w-screen bg-blue-50 bg-opacity-50 shadow-md mb-10">
	<div id="contact-info" class="container mx-auto max-w-prose text-center text-dark py-4 z-10 ">
		<?php if (is_front_page()): ?>
			<p class="z-10 mb-2 font-serif italic font-maple">North South Yacht Sales is Ontario's fastest-growing brokerage. With 8 locations across the province and the Caribbean, we can help you find the boat of your dreams at the best prices available. You will be guided by certified Yacht Brokers helping you make the best choices all the way through the buying process.</p>
		<?php endif; ?>
