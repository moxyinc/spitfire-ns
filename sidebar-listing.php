<div id="sidebar">
	<div class="inner">
		...
		<?php $title = get_the_title(); ?>
			...
			<!-- <h3 class="text-primary mb-6"><?php //echo $title; ?></h3> -->
			<h4 class="text-secondary">For information contact:</h4>
			<section "listing-broker-info" class="author flex flex-wrap  justify-start -ml-3 my-3 text-primary">
			...
			<h3 class="text-dark font-maple font-bold italic"><?php the_field( 'price' ); ?></h3>
			
	
			<?php if ( is_active_sidebar( 'sidebar-1' ) ) : ?>
				<div id="secondary" class="widget-area text-primary mt-12" role="complementary">
